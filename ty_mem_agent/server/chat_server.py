...
class ChatServer:
    ...
    def __init__(self):
        ...
        # 注册通用聊天路由
        self._register_general_chat_routes()
...
标题："""
    ...
    def _register_general_chat_routes(self):
        """注册通用聊天路由"""
        from ty_mem_agent.server.general_chat_routes import register_general_chat_routes
        register_general_chat_routes(self.app)
